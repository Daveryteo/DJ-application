...
void DJAudioPlayer::setPostitionRelative(double pos)
{
    if (pos < 0 || pos > 1.0)
    {
        std::cout << "DJAudioPlayer::setPostitionRelative pos should be between 0 and 1.0" << std::endl;
    }
    else
    {
